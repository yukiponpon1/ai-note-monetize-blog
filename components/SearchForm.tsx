...
export const SearchForm = ({
  ...
  >
    ...
    <input
      ...
      className={`w-full rounded-md border border-line bg-surface text-ink shadow-soft outline-none transition placeholder:text-muted focus:border-sky focus:shadow-glow ${
        compact
