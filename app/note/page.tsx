    ...
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
        <div>
          ...
          <h1 className="mt-3 max-w-3xl font-serif text-4xl font-bold leading-tight tracking-normal text-ink sm:text-5xl">
          ...
          <section className="mt-8 rounded-lg border border-line bg-surface p-6 text-ink shadow-soft">
            <h2 className="font-serif text-2xl font-bold tracking-normal">購入前の考え方</h2>
