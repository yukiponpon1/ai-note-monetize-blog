      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
        <div>
          ...
          <section className="mt-8 rounded-2xl border border-line bg-surface p-6 shadow-soft">
            ...
            <ul className="mt-5 grid gap-3">
              {items.map((item) => (
                <li
                  key={item}
                  className="rounded-xl border border-line bg-paper px-4 py-3 text-sm leading-7 text-muted"
                >
                  {item}
                </li>
              ))}
          ...
          <section className="mt-8 rounded-2xl border border-line bg-surface p-6 text-ink shadow-soft">
            ...
            <Link
              href="/free-gift"
              className="mt-5 inline-flex rounded-full bg-sky px-5 py-3 text-sm font-bold text-white hover:bg-coral"
            >
              先に無料特典を見る
            </Link>
          </section>
        ...
        <aside className="space-y-5">
          <section className="rounded-2xl border border-line bg-surface p-5 shadow-soft">
            ...
            <a
              ...
              className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-coral px-5 py-3 text-sm font-bold text-white hover:bg-sky"
            >
              note公式サイトを開く
            </a>
          </section>
